// derived from https://github.com/chinhodado/persona5_calculator/blob/master/data/SkillDataRoyal.js
export const skills = {
  'Absorb Bless': {
  ...
  'Abysmal Surge': {
    ...
    negotiate: 'Awakened God (Arahabaki)'
  },
  'Abyssal Eye': {
    cost: 5000,
  ...
  'Adverse Resolve': {
    ...
    negotiate: 'Battle Fiend (Rakshasa)'
  },
  Agi: {
    cost: 400,
    ...
    negotiate: "Crypt-Dwelling Pyromaniac (Jack-o'-Lantern)"
  },
  Agidyne: {
    cost: 1200,
  ...
  Agilao: {
    ...
    negotiate: 'Girl of the Hanging Tree (Hua Po)'
  },
  Agneyastra: {
    cost: 24,
  ...
  Bloodbath: {
    ...
    negotiate: 'The Black Avenger (Chernobog)'
  },
  'Bloodstained Eyes': {
  ...
  'Brain Buster': {
    ...
    negotiate: 'Monk of the Valley (Kurama Tengu)'
  },
  'Brain Jack': {
    cost: 800,
    ...
    negotiate: 'Rhetorician of the Sea (Forneus)'
  },
  'Brain Shake': {
    cost: 9,
    ...
    negotiate: 'Possessive Dog Ghost (Inugami)'
  },
  'Brainwash Boost': {
  ...
  'Brave Blade': {
    ...
    negotiate: 'Infuriated Wisdom King (Atavaka)'
  },
  'Brave Step': {
    cost: 1600,
  ...
  Bufu: {
    ...
    negotiate: 'Mocking Snowman (Jack Frost)'
  },
  Bufudyne: {
    cost: 1200,
    ...
    negotiate: 'Monarch of Snow (King Frost)'
  },
  Bufula: {
    cost: 800,
    ...
    negotiate: 'Ambassador of Filth (Belphegor)'
  },
  'Burn Boost': {
  ...
  Charge: {
    ...
    negotiate: 'Blood-Thirsty Demoness (Dakini)'
  },
  Checkmate: {
    cost: 9000,
  ...
  Cleave: {
    ...
    negotiate: 'Hunting Puss in Boots (Cait Sith)'
  },
  'Climate Decorum': {
  ...
  Concentrate: {
    ...
    negotiate: 'Decadent False God (Alilat)'
  },
  'Conitemize Boost': {
  ...
  Counterstrike: {
    ...
    negotiate: 'Funerary Warrior (Valkyrie)'
  },
  'Country Maker': {
  ...
  'Deadly Fury': {
    ...
    negotiate: 'Quaking Lady of Shadow (Skadi)'
  },
  'Death Scythe': {
    cost: 20,
  ...
  Deathbound: {
    ...
    negotiate: 'Rebellious Elephant (Girimehkala)'
  },
  'Deathly Illness': {
  ...
  Debilitate: {
    ...
    element: 'support',
    itemize: [ 'Magatsu-Izanagi Picaro' ],
    personas: {
      Dionysus: 76,
      Fafnir: 91,
      Hastur: 0,
    ...
    negotiate: 'Hedonistic Braggart (Dionysus)'
  },
  'Defense Master': {
  ...
  'Demonic Decree': {
    ...
    cost: 3800,
    element: 'curse',
    itemize: [ 'Belial', 'Thanatos Picaro' ],
  ...
  Dia: {
    ...
    negotiate: 'Beguiling Girl (Pixie)'
  },
  'Diamond Dust': {
    cost: 4800,
  ...
  Diarama: {
    ...
    negotiate: 'Prankster Leader (High Pixie)'
  },
  'Die For Me!': {
  ...
  Dormina: {
    ...
    negotiate: 'Envoy of Slumber (Sandman)'
  },
  'Double Fangs': {
    cost: 10,
    ...
    negotiate: 'Twin-Headed Guardian (Orthrus)'
  },
  'Double Shot': {
    cost: 12,
    ...
    negotiate: 'Bringer of Misfortune (Shiki-Ouji)'
  },
  'Draining Mouth': {
  ...
  Eiga: {
    ...
    negotiate: 'Gathering Devil (Choronzon)'
  },
  Eigaon: {
    cost: 1200,
    ...
    negotiate: 'Wandering Reviver (Nebiros)'
  },
  Eiha: {
    cost: 400,
  ...
  'Elec Wall': {
    ...
    negotiate: 'Waterside Nymph (Apsaras)'
  },
  'Electric Bloodline': {
  ...
  'Energy Shower': {
    ...
    negotiate: 'Destructive Beauty (Parvati)'
  },
  'Evade Bless': {
  ...
  'Evil Touch': {
    ...
    negotiate: 'Menacing Owlman (Andras)'
  },
  'Explosive Scheme': {
  ...
  'Fire Amp': {
    ...
    negotiate: 'Deformed Lion God (Chimera)'
  },
  'Fire Boost': {
    ...
    negotiate: 'Midnight Queen (Queen Mab)'
  },
  'Fire Break': {
    cost: 600,
  ...
  'Fire Wall': {
    ...
    negotiate: 'Leafy Old Man (Koropokkuru)'
  },
  'Firm Stance': {
  ...
  'Foul Breath': {
    ...
    negotiate: 'Pulsing Mud (Black Ooze)'
  },
  'Foul Odor': {
  ...
  'Freeze Boost': {
    ...
    negotiate: 'Heretic Goat (Baphomet)'
  },
  Frei: {
    card: 'CJ Theater',
    cost: 400,
    ...
    negotiate: 'Rooftop Lion (Shiisaa)'
  },
  Freidyne: {
    cost: 1200,
    ...
    negotiate: 'Scandalous Queen (Titania)'
  },
  Freila: {
    cost: 800,
  ...
  Garu: {
    ...
    negotiate: 'Mad Marsh Horse (Kelpie)'
  },
  Garudyne: {
    cost: 1000,
    ...
    negotiate: 'Haughty Vulture (Jatayu)'
  },
  Garula: {
    cost: 600,
    ...
    negotiate: 'Tornado Devil (Fuu-Ki)'
  },
  'Gatling Blows': {
    cost: 16,
  ...
  'Ghastly Wail': {
    ...
    negotiate: 'Dancer of Death (Macabre)'
  },
  'Ghost Nest': {
  ...
  Gigantomachia: {
    ...
    negotiate: 'Evil Voracious Dragon (Fafnir)'
  },
  'Gloomy Child': {
  ...
  Hamaon: {
    ...
    negotiate: 'Bearer of the Scales (Anubis)'
  },
  'Hassou Tobi': {
    cost: 25,
  ...
  'Heat Riser': {
    ...
    negotiate: 'Evil Synthetic Organism (Byakhee)'
  },
  'Heat Up': {
    card: 'Trial 50',
  ...
  'Hysterical Slap': {
    ...
    negotiate: 'Life-Draining Spirit (Kumbhanda)'
  },
  'Ice Age': {
    cost: 5400,
  ...
  'Ice Amp': {
    ...
    negotiate: 'Drunken Serpents (Yamata-no-Orochi)'
  },
  'Ice Boost': {
  ...
  Kouga: {
    ...
    negotiate: 'Expressionless Beast (Unicorn)'
  },
  Kougaon: {
    cost: 1200,
  ...
  Kouha: {
    ...
    element: 'bless',
    personas: { Angel: 0 },
    negotiate: 'Heavenly Punisher (Archangel)'
  },
  ...
  'Life Drain': {
    ...
    negotiate: 'Bedside Brute (Incubus)'
  },
  'Life Leech': {
  ...
  Lullaby: {
    ...
    negotiate: 'Woman who brings Ruin (Lilim)'
  },
  Lunge: {
    cost: 5,
    effect: 'Deal light Phys damage to 1 foe.',
    ...
    negotiate: 'Dirty Two-Horned Beast (Bicorn)'
  },
  Mabaisudi: {
    cost: 800,
  ...
  Mabufu: {
    ...
    negotiate: 'Raging Water Demon (Sui-Ki)'
  },
  Mabufudyne: {
    cost: 2200,
    ...
    negotiate: 'The Shadowed One (Scathach)'
  },
  Mabufula: {
    cost: 1600,
  ...
  Mafrei: {
    ...
    negotiate: 'Hunting Wolf Spirit (Makami)'
  },
  Mafreidyne: {
    cost: 2200,
  ...
  Magaru: {
    ...
    negotiate: 'Captivating Dancer (Ame-no-Uzume)'
  },
  Magarudyne: {
    cost: 2000,
    ...
    negotiate: 'Raging Bird God (Garuda)'
  },
  Magarula: {
    cost: 1400,
  ...
  Mahama: {
    ...
    negotiate: 'She of Life and Death (Isis)'
  },
  Mahamaon: {
    ...
    negotiate: 'Fire Assassin (Throne)'
  },
  'Majestic Presence': {
  ...
  Makajam: {
    ...
    negotiate: 'Zealous Messenger (Angel)'
  },
  Makajamaon: {
    cost: 800,
    ...
    negotiate: 'Vampire Moth (Mothman)'
  },
  'Makara Break': {
  ...
  Makouga: {
    ...
    negotiate: 'Divine Warrior (Power)'
  },
  Makougaon: {
    cost: 2200,
    ...
    negotiate: 'Merciless Inquisitor (Dominion)'
  },
  Makouha: {
    cost: 1000,
  ...
  Mamudoon: {
    ...
    negotiate: 'Missionary of Depravity (Belial)'
  },
  Mapsi: {
    cost: 1000,
  ...
  Mapsiodyne: {
    ...
    negotiate: 'Throbbing King of Desires (Mara)'
  },
  Maragi: {
    card: 'CJ BBB',
    cost: 1000,
  ...
  Maragidyne: {
    ...
    negotiate: 'Harlot of Desire (Lilith)'
  },
  Maragion: {
    cost: 1600,
  ...
  Marakukaja: {
    ...
    negotiate: 'Strumming Veena Player (Sarasvati)'
  },
  Marakunda: {
  ...
  Masukunda: {
    ...
    negotiate: 'Killer Teddy Bear (Bugs)'
  },
  Matarukaja: {
    card: 'Jazz 7/10 10/9',
    cost: 2400,
    ...
    negotiate: 'Lamenting Sacrifice (Kushinada)'
  },
  Matarunda: {
    card: 'Jazz 8/7 11/6',
    cost: 2400,
    ...
    negotiate: 'Dancing Witch (Rangda)'
  },
  Mazio: {
    cost: 1000,
  ...
  Maziodyne: {
    ...
    negotiate: 'Thunder Emperor (Thor)'
  },
  Mazionga: {
    card: 'Trial 30',
    cost: 1600,
    ...
    negotiate: 'Storm-Invoking Ptarmigan (Thunderbird)'
  },
  'Me Patra': {
    cost: 800,
  ...
  Mediarama: {
    ...
    negotiate: 'Mountain Girl (Kikuri-Hime)'
  },
  'Megaton Raid': {
    cost: 16,
    ...
    negotiate: 'Guard Dog of Hades (Cerberus)'
  },
  Megido: {
    cost: 1500,
    ...
    element: 'almighty',
    personas: { Thoth: 37 },
    negotiate: 'Chanting Baboon (Thoth)'
  },
  Megidola: {
    cost: 2400,
  ...
  Megidolaon: {
    ...
    negotiate: 'Coffin Borne God (Mot)'
  },
  'Mementos Scan': {
  ...
  'Miracle Punch': {
    ...
    negotiate: 'Auspicious Pachyderm (Ganesha)'
  },
  'Miracle Rush': {
    cost: 16,
  ...
  Mudo: {
    ...
    negotiate: 'Corpse Bird (Onmoraki)'
  },
  'Mudo Boost': {
  ...
  Mudoon: {
    ...
    negotiate: 'Dream-Dwelling Skull (Loa)'
  },
  'Myriad Slashes': {
    cost: 20,
  ...
  'Negative Pile': {
    ...
    negotiate: 'Slithering Snakewoman (Lamia)'
  },
  'Neo Cadenza': {
    cost: 2400,
  ...
  'Nocturnal Flash': {
    ...
    negotiate: 'Self-Infatuated Star (Narcissus)'
  },
  'Nuke Amp': {
  ...
  'Ominous Words': {
    ...
    negotiate: 'Corpse-Eating Corpse (Pisaca)'
  },
  'One-shot Kill': {
    cost: 17,
    ...
    negotiate: 'Spear-Wielding General (Cu Chulainn)'
  },
  'Oni Kagura': {
    cost: 16,
  ...
  Patra: {
    ...
    negotiate: 'Troublesome Maid (Silky)'
  },
  'Phantom Show': {
    cost: 400,
  ...
  'Power Slash': {
    ...
    negotiate: 'Brutal Cavalryman (Berith)'
  },
  "President's Insight": {
    card: 'Ring of Greed',
    cost: 1500,
  ...
  Psi: {
    ...
    negotiate: 'Hanging Tree Spirit (Kodama)'
  },
  Psio: {
    cost: 800,
    ...
    negotiate: 'Wishless Star (Kaiwan)'
  },
  Psiodyne: {
    cost: 1200,
    ...
    negotiate: 'Sacrificial Pyrekeeper (Moloch)'
  },
  'Psy Amp': {
  ...
  'Psy Wall': {
    ...
    negotiate: 'Unfaithful Dream-King (Oberon)'
  },
  'Psychic Bloodline': {
  ...
  Pulinpa: {
    ...
    negotiate: 'Gallows Flower (Mandrake)'
  },
  'Rage Boost': {
  ...
  Rakukaja: {
    ...
    negotiate: 'Apprentice in a Jug (Agathion)'
  },
  Rakunda: {
    cost: 800,
    ...
    negotiate: 'Jealous Lover (Leanan Sidhe)'
  },
  Rampage: {
    cost: 13,
    ...
    negotiate: 'Chivalrous Fiend (Oni)'
  },
  'Rare Antibody': {
  ...
  Revolution: {
    ...
    negotiate: 'Pagan Saviour (Melchizedek)'
  },
  'Riot Gun': {
    cost: 24,
  ...
  Salvation: {
    ...
    element: 'healing',
    itemize: [ 'Izanagi-no-Okami Picaro' ],
    personas: {
      Ardha: 90,
      Attis: 0,
      Cybele: 89,
  ...
  'Sharp Student': {
    ...
    negotiate: 'Torn King of Desires (Mara)'
  },
  'Shining Arrows': {
    cost: 2200,
  ...
  Sledgehammer: {
    ...
    negotiate: 'Embittered Blacksmith (Ippon-Datara)'
  },
  'Sleep Boost': {
    effect: 'Increase chance of inflicting Sleep.',
    element: 'passive',
    personas: { Sandman: 28, Succubus: 11 },
    negotiate: 'Twilight Prostitute (Succubus)'
  },
  Snap: {
    cost: 9,
    ...
    negotiate: 'Night-Walking Warrior (Mokoi)'
  },
  'Soul Chain': {
    card: 'Network Fusion',
  ...
  Sukukaja: {
    ...
    negotiate: 'Noisy Mountain Spirit (Sudama)'
  },
  Sukunda: {
    cost: 800,
    ...
    negotiate: 'Piggyback Demon (Obariyon)'
  },
  Summon: {
  ...
  'Survival Trick': {
    ...
    negotiate: 'Abyssal King of Avarice (Abaddon)'
  },
  'Swift Strike': {
    cost: 17,
    ...
    negotiate: 'Defeated Avenger (Take-Minakata)'
  },
  'Sword Dance': {
    cost: 21,
  ...
  Tarukaja: {
    ...
    negotiate: 'War-Hungry Horseman (Eligor)'
  },
  Tarunda: {
    cost: 800,
    ...
    negotiate: 'Viscid Rotting Meat (Slime)'
  },
  Taunt: {
    cost: 300,
    ...
    negotiate: 'Foolish Monk (Koppa Tengu)'
  },
  'Tempest Slash': {
    cost: 17,
    ...
    negotiate: 'Nimble Monkey King (Hanuman)'
  },
  Tentarafoo: {
    cost: 800,
  ...
  'Terror Claw': {
    ...
    negotiate: 'Ascended Feline (Nekomata)'
  },
  'Tetra Break': {
    ...
    negotiate: 'itemized Ghost (Legion)'
  },
  Tetraja: {
    card: 'CJ Maid Cafe',
    cost: 2400,
  ...
  Tetrakarn: {
    ...
    negotiate: 'Vicious Pentagram (Decarabia)'
  },
  'Thermal Conduct': {
  ...
  'Vajra Blast': {
    ...
    negotiate: 'Samurai Killer (Kin-Ki)'
  },
  'Vault Guardian': {
  ...
  'Vorpal Blade': {
    ...
    negotiate: 'The Blackened Fury (Kali)'
  },
  'Wage War': {
    cost: 800,
    ...
    negotiate: 'Human-Eating Lady (Yaksini)'
  },
  'Wealth of Lotus': {
  ...
  'Wind Boost': {
    ...
    negotiate: 'Reviled Dictator (Baal)'
  },
  'Wind Break': {
    cost: 600,
    ...
    negotiate: 'Thief of Tablets (Anzu)'
  },
  'Wind Wall': {
    cost: 1800,
  ...
  Zionga: {
    ...
    negotiate: 'Cavern Snakeman (Naga)'
  }
}
