// derived from https://github.com/chinhodado/persona5_calculator/blob/master/data/ItemData.js
export const items = {
  'Archangel Bra': {
  ...
  'Black Headband': { type: 'Accessory', description: '+40 SP' },
  'Black Jacket': {
  ...
  Daffodils: { type: 'Accessory', description: '+Null Despair' },
  'Darkness Ring': { type: 'Accessory', description: '+Evade Curse (high)' },
  'Death Contract': {
  ...
  'Hua Khon': { type: 'Accessory', description: 'Prevents insta-kill from Bless' },
  'Judge of the Dead': {
    type: 'Gun - Makoto only',
    description: 'Atk 380 / Acc 92 / Rounds 6 / All stats +10'
  },
  'Khamrai Tao': { type: 'Accessory', description: '+Reduce Fire dmg (high)' },
  'King Frost Cape': {
    type: 'Protector - Unisex',
    description: 'Def 140 / Ev 16 / +Reduce Ice dmg (high)'
  },
  'Koh-i-Noor': { type: 'Accessory', description: 'All stats +2 / +Bless' },
  Kougaon: { skillCard: true },
  'Kuzuryu Gouhou': {
    type: 'Gun - Yusuke only',
  ...
  Orlov: { type: 'Accessory', description: 'Ma +3 / +Repel Phys (high)' },
  'Paradise Lost': {
    type: 'Weapon - Joker only',
  ...
  'Petra Genetrix': { type: 'Accessory', description: '+Null Burn' },
  'Pumpkin Bomb': {
    type: 'Gun - Ryuji only',
  ...
  Shackles: { type: 'Accessory', description: '+Null Rage' },
  'Silk Dress': {
    type: 'Protector - Women only',
  ...
  'Stone of Scone': { type: 'Accessory', description: 'En +3 / +Reduce Phys dmg (low)' },
  Sudarshana: {
    type: 'Gun - Morgana only',
  ...
  'Thunder Band': { type: 'Accessory', description: '+Null Shock' },
  'Thunder Horns': { type: 'Accessory', description: 'En +10 / +Fire attacks' },
  'Tyrant Pistol': {
    type: 'Gun - Joker only',
